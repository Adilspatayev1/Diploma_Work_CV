...
class VNet(nn.Module):
    ...
    def __init__(self, dice=False):
        ...
        self.conv1 =        nn.Conv2d(1, 16, 5, stride=1, padding=2)
        self.conv1_down =   nn.Conv2d(16, 32, 2, stride=2, padding=0)           # conv1
        self.conv2a =       nn.Conv2d(32, 32, 5, stride=1, padding=2)
        self.conv2b =       nn.Conv2d(32, 32, 5, stride=1, padding=2)
        self.conv2_down =   nn.Conv2d(32, 64, 2, stride=2, padding=0)           # conv2
        ...
        self.conv3_down =   nn.Conv2d(64, 128, 2, stride=2, padding=0)          # conv3
        ...
        self.conv4_down =   nn.Conv2d(128, 256, 2, stride=2, padding=0)         # conv4
        ...
        self.conv5_up =     nn.ConvTranspose2d(256, 128, 2, stride=2, padding=0)# conv5
        ...
        self.conv6_up =     nn.ConvTranspose2d(256, 64, 2, stride=2, padding=0) # conv6
        ...
        self.conv7_up =     nn.ConvTranspose2d(128, 32, 2, stride=2, padding=0) # conv7
        self.conv8a =       nn.Conv2d(64, 64, 5, stride=1, padding=2)
        self.conv8b =       nn.Conv2d(64, 64, 5, stride=1, padding=2)
        self.conv8_up =     nn.ConvTranspose2d(64, 16, 2, stride=2, padding=0)  # conv8
        self.conv9 =        nn.Conv2d(32, 32, 5, stride=1, padding=2)
        self.conv9_1x1 =    nn.Conv2d(32, 2, 1, stride=1, padding=0)            # conv9
    ...
    def forward(self, x):
        ...
        conv3 = F.relu(self.conv3_down(layer3))         # conv3
        ...
        conv4 = F.relu(self.conv4_down(layer4))         # conv4
        ...
        conv5 = F.relu(self.conv5_up(layer5))           # conv5
        ...
        conv6 = F.relu(self.conv6_up(layer6))           # conv6
...
class VNet_Xtra(nn.Module):
    ...
    def forward(self, x):
        ...
        layer9 = torch.softmax(layer9, dim=1)
